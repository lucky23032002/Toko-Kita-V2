      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{ route('admin.product.update', $product) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row mb-3">
              <label for="category_id" class="col-form-label col-sm-2">Category</label>
              <div class="col-sm-10">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-sm-10">
                <input type="number" class="slug-from form-control @error('price') is-invalid @enderror" id="price"
            ...
            <div class="form-group row mb-3">
              ...
              <div class="img-container d-flex justify-content-end">
                <img height="120" width="120" src="{{ asset('storage/' . $product->image) }}"
            ...
            <div class="d-flex justify-content-end">
              ...
              <a class="btn btn-warning" href="{{ route('admin.product.index') }}">
                Cancel
              </a>
            </div>
